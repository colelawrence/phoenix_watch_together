...
const ua0 = { Id: 0, Name: "Speedy Gonzalez" }
...
const ua1: R.User = { Id: 0, Name: "Tom Cat" }
const ua2: R.User = { Id: 1, Name: "Jerry Mouse" }
const ua3: R.User = { Id: 2, Name: "Tweety Bird" }
const ua4: R.User = { Id: 3, Name: "Sylvester Cat" }
const ua5: R.User = { Id: 4, Name: "Foghorn Leghorn" }
  ...
  GroupOpened: <R.DeviceState> {
    ...
    LoggedIn: {
      ...
      OpenGroup: {
        Group: g0,
        Messages: [
          { Id: 0, Date: ahm(now1, 0, 0), Text: "Right on!", User: ua0 },
          { Id: 1, Date: ahm(now1, 0, -1), Text: "Does fuck you sound good?", User: ua4 },
          { Id: 2, Date: ahm(now1, 0, -5), Text: "The weather is great", User: ua4 },
          { Id: 3, Date: ahm(now1, 0, -5), Text: "I'm interested!", User: ua3 },
          { Id: 4, Date: ahm(now1, 0, -7), Text: "The park sounds fun", User: ua2 },
          { Id: 5, Date: ahm(now1, 0, -10), Text: "Let's go to the park!", User: ua0 }, // You
          { Id: 6, Date: ahm(now1, 0, -13), Text: "What is everyone feeling like doing", User: ua1 },
          { Id: 7, Date: ahm(now1, 0, -13), Text: "Hello Everyone", User: ua1 },
        ],
        ModalOpen: null,
